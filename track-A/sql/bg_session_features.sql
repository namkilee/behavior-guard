WITH sessions AS (
    /* sessions_query: 너의 "SELECT user_id, client_name, session_key, ... tokens/outcomes/route_groups/dt_buckets ..." 쿼리 전체 */
    WITH
